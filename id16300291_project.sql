...
--
-- Host: localhost:3306
-- Generation Time: Apr 05, 2021 at 04:12 PM
...
('CSE001', 'Software Developer Intern', 'CSE', 'AJ SOFTWARE PVT LMT', 'bangalore', 'Python, AI, cgpa > 8.8', 'https://www.google.com/'),
('MEC001', 'Boston Turbomachinery Engineering Internship', 'MEC', 'SOFTINWAY TURBOMACHINERY SOLUTIONS , BANGLORE', 'bangalore', 'Basic idea of turbomachinery, cgpa > 8.5', 'https://www.google.com/'),
('ECE001', 'Robotics Electronics Engineering Internship', 'ECE', 'SVR INFOTECH', 'pune', 'Proteus, KiCAD for design and simulation of PCBs & electronics circuits', 'https://www.google.com/'),
('CSE002', 'Summer Internship for BE (CS/IT)', 'CSE', 'ENDEAVOR IT SOLUTION', 'indore', 'Any B.E/B.Tech pursuing students (any semester) can apply.', 'https://www.instagram.com/'),
('CSE003', 'Backend Intern', 'CSE', 'SEIMENS', 'hyderabad', 'cgpa > 8', 'https://www.facebook.com/'),
('ECE002', 'Embedded Systems Internship', 'ECE', 'RAPTEE ENERGY', 'delhi', 'Basic knowledge of Python,Experience with Raspberry Pi, Arduinos', 'https://www.instagram.com/'),
('ECE003', 'Electronic Circuit Design Internship', 'ECE', ' MECHANICAL CHEF', 'Online', 'N/A', 'https://www.facebook.com/'),
('MEC002', 'Hardware Design (CAD And Mechanical) Internship', 'MEC', 'E2EM TECHNOLOGIES PRIVATE LIMITED', 'noida', 'N/A', 'https://www.instagram.com/'),
('MEC003', 'Internship Program for Mechanical Engineers - 2016 - 2017 - 2018 - 2019', 'MEC', 'TATA MOTORS', 'vishakapatnam', 'cgpa > 9.3', 'https://www.facebook.com/');
...
--
ALTER TABLE `ans`
  ADD CONSTRAINT `ans_ibfk_1` FOREIGN KEY (`qno`) REFERENCES `qna` (`qno`);
COMMIT;
