...
if ($branch == 'coe' or $branch == 'ced') {
    $result = mysqli_query($con,"SELECT * FROM cse_table");
}
else if ($branch=='esd'or $branch=='evd' or $branch=='edm') {
    $result = mysqli_query($con,"SELECT * FROM ece_table");
}
else if($branch=='msm') {
    $result = mysqli_query($con,"SELECT * FROM msm_table");
}
else if($branch=='mdm'or $branch='mfd' or $branch='mpd') {
    $result = mysqli_query($con,"SELECT * FROM mec_table");
}
